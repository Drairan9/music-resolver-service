import { DummyYouTubeChannel } from './dummy_youtube_channel';
import { DummyYouTubeThumbnail } from './dummy_youtube_thumbnail';
...
interface DummyVideoOptions {
     ...
     *
     * The property names of DummyVideoMusic change depending on your region's language.
     */
    music?: DummyVideoMusic[];
    /**
     ...
     */
    chapters: DummyVideoChapter[];
}

export interface DummyVideoChapter {
    /**
     ...
     */
    thumbnails: DummyYouTubeThumbnail[];
}

/**
 * Class for YouTube Video url
 */
export class DummyYouTubeVideo {
    /**
     * YouTube Video ID
     */
    id?: string;
    ...
    constructor(data: any) {
        ...
        for (const thumb of data.thumbnails) {
            thumbnails.push(new DummyYouTubeThumbnail(thumb));
        }
        this.thumbnails = thumbnails || [];
        this.channel = new DummyYouTubeChannel(data.channel) || {};
