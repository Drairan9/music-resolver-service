export interface DummyChannelIconInterface {
    /**
 ...
 */
export class DummyYouTubeChannel {
    /**
     ...
     */
    icons?: DummyChannelIconInterface[];
    /**
